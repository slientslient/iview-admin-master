      ...
      <Card >
        ...
        <Form ref="loginForm" :model="form" :rules="rules" @keydown.enter.native="handleSubmit" >
          ...
          <FormItem prop="password" span="8">
            <p>原始密码</p>
            <Input type="password" v-model="form.password" placeholder="请输入原始密码">
        <span slot="prepend">
          ...
          <FormItem prop="adminRole" span="8" >
            <p>新密码</p>
            <Input v-model="form.adminRole" placeholder="请输入新密码">
        <span slot="prepend">
          ...
          <FormItem prop="passwordCom" span="8">
            <p>确认密码</p>
            <Input type="password" v-model="form.passwordCom" placeholder="请再次输入新密码">
        <span slot="prepend">
          <Icon :size="14" type="md-lock"></Icon>
        </span>
            </Input>
